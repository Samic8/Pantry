...
var author$project$Main$NewItem = F6(
	function (name, onHand, maxOnHand, unit, userEstimateRunOut, confirmed) {
		return {confirmed: confirmed, maxOnHand: maxOnHand, name: name, onHand: onHand, unit: unit, userEstimateRunOut: userEstimateRunOut};
	});
...
var author$project$Main$mapItem = A7(
		...
		return _Utils_Tuple2(
			{
				...
				newCupboardName: '',
				newItem: A6(author$project$Main$NewItem, '', 500, 500, 'g', '4 weeks', false),
				newItemWarning: '',
				restockMode: author$project$Main$Off,
				settings: author$project$Main$Off,
				title: '',
				url: url
			},
			elm$http$Http$get(
...
var author$project$Main$SaveChangedItems = {$: 'SaveChangedItems'};
...
var author$project$Main$filterOutUnchanged = function (items) {
	return A2(
		...
		function (item) {
			return A2(author$project$Main$hasEstimateOnHandChanged, item, false);
		},
		items);
};
var author$project$Main$maybeSaveChangedItems = function (model) {
	return ((elm$core$List$length(
		author$project$Main$filterOutUnchanged(model.items)) > 0) && _Utils_eq(model.mouseMoveFocus, elm$core$Maybe$Nothing)) ? author$project$Main$SaveChangedItems : author$project$Main$NoOp;
};
var author$project$Main$OnBarMouseUp = {$: 'OnBarMouseUp'};
var author$project$Main$BarDragingMouseMove = function (a) {
	return {$: 'BarDragingMouseMove', a: a};
};
var author$project$Main$toStringValue = function (mouseMove) {
	return author$project$Main$BarDragingMouseMove(mouseMove);
};
...
var author$project$Main$mouseDecoder = A2(
	elm$json$Json$Decode$map,
	author$project$Main$toStringValue,
	A2(
		...
		_List_fromArray(
			[
				...
				elm$core$Basics$always(
					author$project$Main$maybeSaveChangedItems(model)))
			]));
};
...
var author$project$Main$GotNewItems = function (a) {
	return {$: 'GotNewItems', a: a};
};
...
var author$project$Main$SaveNewItemServer = {$: 'SaveNewItemServer'};
var author$project$Main$Unit = {$: 'Unit'};
var elm$json$Json$Encode$int = _Json_wrap;
var elm$json$Json$Encode$string = _Json_wrap;
var author$project$Main$buildEncodedItemList = elm$core$List$map(
	function (item) {
		return _List_fromArray(
			[
				_Utils_Tuple2(
	...
	function (model, id, mouseMove) {
		...
		var itemMaxOnHand = elm$core$List$sum(
			A2(
				elm$core$List$map,
				function (item) {
					return item.maxOnHand;
				},
				A2(author$project$Main$getItemFromId, model.items, id)));
		return elm$core$String$fromInt(
			elm$core$Basics$round(itemMaxOnHand * percentageFloat));
	});
var author$project$Main$Item = F8(
	function (id, name, estimateDays, estimateOnHand, maxOnHand, unit, userEstimateRunOut, initialEstimateOnHand) {
		return {estimateDays: estimateDays, estimateOnHand: estimateOnHand, id: id, initialEstimateOnHand: initialEstimateOnHand, maxOnHand: maxOnHand, name: name, unit: unit, userEstimateRunOut: userEstimateRunOut};
	});
...
var author$project$Main$transformItemsResponse = function (itemsResponse) {
	return A2(
		elm$core$List$map,
		function (itemRes) {
...
var author$project$Main$buildNewItemsFromResponse = function (itemsResponse) {
	return author$project$Main$transformItemsResponse(itemsResponse);
};
...
var author$project$Main$isValidTimeString = function (timeString) {
	var splitTimeString = A2(elm$core$String$split, ' ', timeString);
	var unit = elm$core$String$toLower(
		A2(
			elm$core$Maybe$withDefault,
			'',
			elm$core$List$head(
				A2(elm$core$List$drop, 1, splitTimeString))));
	var amount = A2(
		elm$core$Maybe$withDefault,
		'',
		elm$core$List$head(splitTimeString));
	return (!_Utils_eq(
		...
		unit,
		_List_fromArray(
			['week', 'day', 'month', 'year', 'weeks', 'days', 'months', 'years']));
};
...
var author$project$Main$updateItems = F4(
		...
		while (true) {
			switch (msg.$) {
					...
					if (result.$ === 'Ok') {
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									items: author$project$Main$buildNewItemsFromResponse(cupboard.itemsResponse),
				...
				case 'ModifyName':
					var id = msg.a;
					var newName = msg.b;
					var updatedItems = A4(author$project$Main$updateItems, model, id, newName, author$project$Main$Name);
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{items: updatedItems}),
						elm$core$Platform$Cmd$none);
				case 'ModifyEstimateOnHandBar':
					var id = msg.a;
					...
					if (_n3.$ === 'On') {
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									items: A4(author$project$Main$updateItems, model, id, newEstimate, author$project$Main$EstimateOnHand)
								}),
							elm$core$Platform$Cmd$none);
					} else {
						return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				...
				case 'ModifyMaxOnHand':
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								items: A4(author$project$Main$updateItems, model, id, newMax, author$project$Main$MaxOnHand)
							}),
						elm$core$Platform$Cmd$none);
				case 'ModifyUnit':
					var id = msg.a;
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								items: A4(author$project$Main$updateItems, model, id, newUnit, author$project$Main$Unit)
							}),
						elm$core$Platform$Cmd$none);
				case 'ModifyNewName':
					var name = msg.a;
					var settings = (name !== '') ? author$project$Main$On : model.settings;
					var newItem = model.newItem;
					var updatedNewItem = _Utils_update(
						newItem,
						{name: name});
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{newItem: updatedNewItem, settings: settings}),
						elm$core$Platform$Cmd$none);
				case 'ModifyNewOnHand':
					var onHand = msg.a;
					var newItem = model.newItem;
					var updatedNewItem = _Utils_update(
						newItem,
						{
							onHand: author$project$Main$parseValueToInt(onHand)
						});
					return _Utils_Tuple2(
						_Utils_update(
							model,
						...
						elm$core$Platform$Cmd$none);
				case 'ModifyNewEstimateTime':
					var estimateTime = msg.a;
					var newItem = model.newItem;
					var updatedNewItem = _Utils_update(
						newItem,
						{userEstimateRunOut: estimateTime});
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{newItem: updatedNewItem}),
						elm$core$Platform$Cmd$none);
				case 'ValidateNewEstimateTime':
					return author$project$Main$isValidTimeString(model.newItem.userEstimateRunOut) ? _Utils_Tuple2(
						_Utils_update(
							model,
							{newItemWarning: ''}),
						...
						_Utils_update(
							model,
							{newItemWarning: 'Estimated Empty needs to be in the format of \"4 weeks\"'}),
						elm$core$Platform$Cmd$none);
				case 'ModifyNewMaxOnHand':
					var maxOnHand = msg.a;
					var newItem = model.newItem;
					var updatedNewItem = _Utils_update(
						newItem,
						{
							maxOnHand: author$project$Main$parseValueToInt(maxOnHand)
						});
					return _Utils_Tuple2(
						_Utils_update(
							model,
				...
				case 'ModifyNewUnit':
					...
					return _Utils_Tuple2(
						...
						elm$core$Platform$Cmd$none);
				case 'SaveNewItem':
					if (author$project$Main$isValidTimeString(model.newItem.userEstimateRunOut)) {
						var newItem = model.newItem;
						var updatedNewItem = _Utils_update(
							newItem,
							{confirmed: true});
						var $temp$msg = author$project$Main$SaveNewItemServer,
											...
											elm$json$Json$Encode$object(
												_List_fromArray(
													[
														_Utils_Tuple2(
														'name',
														elm$json$Json$Encode$string(model.newItem.name)),
														_Utils_Tuple2(
														'maxOnHand',
														elm$json$Json$Encode$int(model.newItem.maxOnHand)),
														_Utils_Tuple2(
														'onHand',
														elm$json$Json$Encode$int(model.newItem.onHand)),
														_Utils_Tuple2(
														'unit',
														elm$json$Json$Encode$string(model.newItem.unit)),
														_Utils_Tuple2(
														'userEstimateRunOut',
				...
				case 'GotNewItem':
					...
					if (result.$ === 'Ok') {
						...
						var updatedNewItem = _Utils_update(
							newItem,
							{confirmed: false, name: ''});
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									items: A2(author$project$Main$processNewItem, model, item),
									newItem: updatedNewItem
								}),
							elm$core$Platform$Cmd$none);
					} else {
				...
				case 'BarDragingMouseMove':
					var mouseMove = msg.a;
					var _n5 = model.mouseMoveFocus;
					if (_n5.$ === 'Just') {
						if (_n5.a.$ === 'EstimateOnHandMove') {
							var _n6 = _n5.a;
							var _n7 = model.restockMode;
							if (_n7.$ === 'On') {
								...
								return _Utils_Tuple2(
									_Utils_update(
										...
										{
											items: A4(
												author$project$Main$updateItems,
												model,
												id,
				...
				case 'GotNewItems':
					var result = msg.a;
					if (result.$ === 'Ok') {
						var itemsResponse = result.a;
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									items: author$project$Main$buildNewItemsFromResponse(itemsResponse)
								}),
							elm$core$Platform$Cmd$none);
					} else {
						return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				...
				case 'CreateCupboard':
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				case 'OnNewCupboardNameChange':
					var newVal = msg.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{newCupboardName: newVal}),
						elm$core$Platform$Cmd$none);
				default:
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
			}
...
var author$project$Main$Cupboard = function (a) {
	return {$: 'Cupboard', a: a};
};
...
var author$project$Main$getRoute = elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			A2(elm$url$Url$Parser$map, author$project$Main$Create, elm$url$Url$Parser$top),
			A2(
			elm$url$Url$Parser$map,
			author$project$Main$Cupboard,
			A2(
				elm$url$Url$Parser$slash,
				elm$url$Url$Parser$s('cupboard'),
...
var author$project$Main$isCreatePage = function (url) {
	return _Utils_eq(
		A2(elm$url$Url$Parser$parse, author$project$Main$getRoute, url),
		elm$core$Maybe$Just(author$project$Main$Create));
};
var author$project$Main$OnNewCupboardNameChange = function (a) {
	return {$: 'OnNewCupboardNameChange', a: a};
};
...
var author$project$Main$viewCreate = function (model) {
	return _List_fromArray(
		[
			...
			_List_fromArray(
				[
					elm$html$Html$Attributes$class('getStartedContainer')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('getStartedInput'),
							elm$html$Html$Attributes$value(model.newCupboardName),
							elm$html$Html$Events$onInput(author$project$Main$OnNewCupboardNameChange),
							elm$html$Html$Attributes$placeholder('Give your cupboard a name')
						]),
					_List_Nil),
					A2(
					elm$html$Html$a,
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('button getStartedButton'),
							elm$html$Html$Attributes$href('/cupboard/' + model.newCupboardName)
						]),
					_List_fromArray(
						[
...
var author$project$Main$buildListHeader = function (settings) {
	return _List_fromArray(
		[
			A2(
			elm$html$Html$span,
			...
			_List_fromArray(
				[
					elm$html$Html$text('Estimated Empty In')
				])),
			A2(
			elm$html$Html$span,
			_List_Nil,
			_List_fromArray(
				[
					elm$html$Html$text('Estimated Remaining Today')
				])),
			A2(
			elm$html$Html$span,
			_List_fromArray(
			...
			_List_fromArray(
				[
					elm$html$Html$text('Restock Quantity')
				]))
		]);
};
var author$project$Main$buildNewItemHeader = function (settings) {
	return _List_fromArray(
		[
			A2(
			elm$html$Html$span,
			...
			_List_fromArray(
				[
					elm$html$Html$text('I might run out in')
				])),
			A2(
			elm$html$Html$span,
			_List_Nil,
			_List_fromArray(
				[
					elm$html$Html$text('I currently have')
				])),
			A2(
			elm$html$Html$span,
			_List_fromArray(
			...
			_List_fromArray(
				[
					elm$html$Html$text('When I restock I want')
				]))
		]);
};
...
var author$project$Main$ModifyEstimateOnHandBar = F2(
	function (a, b) {
		return {$: 'ModifyEstimateOnHandBar', a: a, b: b};
	});
...
var author$project$Main$ModifyUnit = F2(
	function (a, b) {
		return {$: 'ModifyUnit', a: a, b: b};
	});
...
var author$project$Main$buildQuantityRemainingWidth = function (item) {
...
var author$project$Main$viewItemRow = F3(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('bar tooltipParent'),
							elm$html$Html$Attributes$classList(
							_List_fromArray(
								[
									_Utils_Tuple2(
						...
						[
							...
							_List_fromArray(
								[
									...
									A2(
										author$project$Main$ModifyEstimateOnHandBar,
										item.id,
							...
							_List_fromArray(
								[
									elm$html$Html$text(
									'Estimated Remaining: ' + (elm$core$String$fromInt(item.estimateOnHand) + (' ' + item.unit)))
								]))
						])),
					A2(
					elm$html$Html$div,
								...
								[
									...
									_List_fromArray(
										[
											...
											elm$html$Html$Events$onInput(
											author$project$Main$ModifyUnit(item.id))
										]),
									_List_Nil)
								]))
						]))
...
var author$project$Main$buildRows = function (model) {
	return A2(
		elm$core$List$map,
		function (item) {
			return A3(author$project$Main$viewItemRow, item, model.restockMode, model.settings);
		},
		A2(author$project$Main$filterUsingPercentage, model, model.items));
};
var author$project$Main$ModifyNewEstimateTime = function (a) {
	return {$: 'ModifyNewEstimateTime', a: a};
};
var author$project$Main$ModifyNewMaxOnHand = function (a) {
	return {$: 'ModifyNewMaxOnHand', a: a};
};
var author$project$Main$ModifyNewName = function (a) {
	return {$: 'ModifyNewName', a: a};
};
var author$project$Main$ModifyNewOnHand = function (a) {
	return {$: 'ModifyNewOnHand', a: a};
};
var author$project$Main$ModifyNewUnit = function (a) {
	return {$: 'ModifyNewUnit', a: a};
};
var author$project$Main$SaveNewItem = {$: 'SaveNewItem'};
var author$project$Main$ValidateNewEstimateTime = {$: 'ValidateNewEstimateTime'};
var author$project$Main$getConfirmTickClassList = function (newItem) {
	return _List_fromArray(
		[
			_Utils_Tuple2('row__confirmTick', true),
			_Utils_Tuple2('hidden', newItem.name === ''),
			_Utils_Tuple2('row__confirmTick--hidden', newItem.confirmed)
		]);
};
var author$project$Main$newItemRowHeaderMarginTop = function (newItem) {
	return (newItem.name === '') ? '0' : '20px';
};
var author$project$Main$onConfirmKeyDown = function (key) {
	return (key === 13) ? author$project$Main$SaveNewItem : author$project$Main$NoOp;
};
...
var author$project$Main$shouldHideNewRowHeader = F2(
	function (newItem, items) {
		return ((newItem.name !== '') && (!elm$core$List$length(items))) ? true : (newItem.name === '');
	});
...
var author$project$Main$viewNewRow = F2(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('listContainer__header'),
							elm$html$Html$Attributes$classList(
							_List_fromArray(
								[
									_Utils_Tuple2(
									'hidden',
									A2(author$project$Main$shouldHideNewRowHeader, newItem, model.items))
								])),
							A2(
							elm$html$Html$Attributes$style,
							'margin-top',
							author$project$Main$newItemRowHeaderMarginTop(newItem))
						]),
					author$project$Main$buildNewItemHeader(model.settings)),
					A2(
					elm$html$Html$div,
					_List_fromArray(
						[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									elm$html$Html$Attributes$class('inputBox'),
									elm$html$Html$Attributes$id('new-item-name-input'),
									elm$html$Html$Events$onInput(author$project$Main$ModifyNewName),
									elm$html$Html$Attributes$value(newItem.name),
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											_Utils_Tuple2('inputBox--covered', newItem.name === '')
										]))
								]),
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											...
											elm$html$Html$Attributes$value(newItem.userEstimateRunOut),
											elm$html$Html$Events$onInput(author$project$Main$ModifyNewEstimateTime),
											elm$html$Html$Events$onBlur(author$project$Main$ValidateNewEstimateTime)
										]),
									_List_Nil)
								])),
							A2(
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											elm$html$Html$Attributes$class('quantity__edit inputBox__innerEdit'),
											elm$html$Html$Events$onInput(author$project$Main$ModifyNewOnHand),
											elm$html$Html$Attributes$value(
											elm$core$String$fromInt(newItem.onHand))
										]),
									_List_Nil),
									A2(
									elm$html$Html$span,
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													elm$html$Html$Attributes$class('quantity__unit__innerEdit inputBox__innerEdit'),
													elm$html$Html$Attributes$value(newItem.unit),
													elm$html$Html$Events$onInput(author$project$Main$ModifyNewUnit)
												]),
											_List_Nil)
										]))
								])),
								...
								[
									...
									_List_fromArray(
										[
											_Utils_Tuple2(
											'hidden',
											_Utils_eq(model.settings, author$project$Main$Off)),
											_Utils_Tuple2('inputBox--covered', newItem.name === '')
										]))
								]),
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											elm$html$Html$Attributes$class('quantity__edit inputBox__innerEdit'),
											elm$html$Html$Events$onInput(author$project$Main$ModifyNewMaxOnHand),
											elm$html$Html$Attributes$value(
											elm$core$String$fromInt(newItem.maxOnHand))
										]),
									_List_fromArray(
										[
											elm$html$Html$text(
							...
							_List_fromArray(
								[
									elm$html$Html$Attributes$classList(
									author$project$Main$getConfirmTickClassList(newItem)),
									elm$html$Html$Events$onClick(author$project$Main$SaveNewItem),
									author$project$Main$onKeyDown(
									function (key) {
										return author$project$Main$onConfirmKeyDown(key);
									}),
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('warningMessage'),
							elm$html$Html$Attributes$classList(
							_List_fromArray(
								[
									_Utils_Tuple2('visibilityHidden', model.newItemWarning === '')
								]))
						]),
					_List_fromArray(
						[
							elm$html$Html$text(model.newItemWarning)
						]))
				]));
	});
...
var author$project$Main$viewCupboard = function (model) {
	return _List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('filters__button button'),
							elm$html$Html$Attributes$classList(
							_List_fromArray(
								[
									_Utils_Tuple2(
			...
			_List_fromArray(
				[
					...
					(elm$core$List$length(model.items) > 0) ? author$project$Main$buildListHeader(model.settings) : author$project$Main$buildNewItemHeader(model.settings)),
					A2(
					elm$html$Html$ul,
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('listContainer__rows'),
							elm$html$Html$Attributes$classList(
							_List_fromArray(
								[
									_Utils_Tuple2(
					...
					author$project$Main$buildRows(model)),
					A2(author$project$Main$viewNewRow, model.newItem, model)
				]))
		]);
};
					...
					[
						...
						_List_fromArray(
							[
								...
								(!author$project$Main$isCreatePage(model.url)) ? A2(
								elm$html$Html$input,
								_List_fromArray(
									[
						...
						author$project$Main$isCreatePage(model.url) ? author$project$Main$viewCreate(model) : author$project$Main$viewCupboard(model))
					]))
			]),
		title: 'Pantry'
	};
